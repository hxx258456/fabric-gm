...
import (
	...
	lifecyclemocks "github.com/hxx258456/fabric-gm/core/cclifecycle/mocks"
	"github.com/hxx258456/fabric-gm/core/common/ccprovider"
	"github.com/hxx258456/fabric-gm/discovery"
	disc "github.com/hxx258456/fabric-gm/discovery/client"
	...
	"github.com/hxx258456/fabric-gm/discovery/support/mocks"
	"github.com/hxx258456/fabric-gm/gossip/api"
	gcommon "github.com/hxx258456/fabric-gm/gossip/common"
	gdisc "github.com/hxx258456/fabric-gm/gossip/discovery"
	...
	msprotos "github.com/hxx258456/fabric-protos-go-gm/msp"
...
func buildBinaries() error {
	var err error
	cryptogen, err = gexec.Build("github.com/hxx258456/fabric-gm/cmd/cryptogen")
	if err != nil {
		return errors.WithStack(err)
	}

	idemixgen, err = gexec.Build("github.com/hxx258456/fabric-gm/cmd/idemixgen")
	if err != nil {
		return errors.WithStack(err)
	}
	return nil
